  ...
  return function(a, b) { return compare(a, b) * direction; };
      ...
      `);
        ...
        if (a.getInput("ELSE") || b.STATEMENT_SUFFIX)
          c = b.statementToCode(a, "ELSE"), b.STATEMENT_SUFFIX && (c = b.prefixLines(b.injectId(
            b.STATEMENT_SUFFIX,
            a
          ), b.INDENT) + c), d += " else {\n" + c + "}";
        return d + "\n";
        ...
        let d;
        if ("NEG" === c)
          return a = b.valueToCode(a, "NUM", Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION) || "0", "-" === a[0] && (a = " " + a), ["-" + a, Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION];
...
`) + "(" + d + ")", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
        ...
        if ("FIRST" === d && "LAST" === e)
          return [g, Order$$module$build$src$generators$javascript$javascript_generator.NONE];
        if (g.match(/^'?\w+'?$/) || f) {
          switch (d) {
            case "FROM_START":
              c = b.getAdjusted(a, "AT1");
          ...
          f = b.getAdjusted(a, "AT1"), a = b.getAdjusted(a, "AT2"), g = b.provideFunction_("subsequence" + c[d] + c[e], `
...
`
      ...
      var JavascriptGenerator$$module$build$src$generators$javascript$javascript_generator = class extends $.CodeGenerator$$module$build$src$core$generator {
        constructor(a = "JavaScript") {
          ...
          for (const b in Order$$module$build$src$generators$javascript$javascript_generator)
            a = Order$$module$build$src$generators$javascript$javascript_generator[b], "string" !== typeof a && (this["ORDER_" + b] = a);
        ...
        getAdjusted(a, b, c = 0, d = false, e = Order$$module$build$src$generators$javascript$javascript_generator.NONE) {
          ...
          if (0 === c && !d)
            return a;
          if ($.isNumber$$module$build$src$core$utils$string(a))
            return a = String(Number(a) + c), d && (a = String(-Number(a))), a;
          0 < c ? a = `${a} + ${c}` : 0 > c && (a = `${a} - ${-c}`);
          d && (a = c ? `-(${a})` : `-${a}`);
      ...
      for (const a in generators$$module$build$src$generators$javascript)
        javascriptGenerator$$module$build$src$generators$javascript.forBlock[a] = generators$$module$build$src$generators$javascript[a];
